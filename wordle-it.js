...
var Aa = ['leah', 'grace', 'sean', 'moses', 'will', 'george', 'carter', 'mary', 'thomas', 'anna', 'olivia', 'preston', 'sophia', 'chase', 'robert', 'graham', 'jackson', 'layla', 'sasha', 'maxx', 'ansley', 'grace', 'blair', 'knox', 'logan', 'brent', 'sarah', 'ryder', 'taylor', 'ryder', 'sophia', 'bryce', 'eliana', 'tyler', 'jack', 'daniel', 'connor', 'brooke', 'edmond', 'kenzo', 'sophia', 'paige', 'tucker', 'margot', 'jones', 'ella', 'marley', 'john', 'harley', 'emmy', 'nora', 'philip', 'john', 'kamran', 'hannah', 'gavin', 'sienna', 'tyson', 'teagan', 'daniel', 'claire', 'julian', 'mcvey', 'dean', 'avery', 'emma', 'claire', 'garret', 'ella', 'betsy', 'amara', 'colt', 'albert', 'amelia', 'audrey', 'kade', 'havana', 'hunter', 'emma', 'andrew', 'ajani', 'grant']
,
    La = ['mitchell', 'daniel',      'carter',      'gavin',      'garret',      'christopher',      'andrew',      'sam',      'robert',      'philip',      'sarah',      'ryan',      'ajani',      'jon',      'nicholas',      'louis',      'connor',      'jones',      'graham',      'will',      'jackson',      'tucker',      'maxx',      'grant',      'hunter',      'tyler',      'franklin',      'braiden',      'preston',      'thomas',      'colt',      'dean',      'kade',      'john',      'moses',      'daniel',      'logan',      'george',      'kamran',      'zachary',      'edmond',      'ryder',      'albert',      'tyson',      'ryder',      'bryce',      'sean',      'kenzo',      'julian',      'william',      'jack',      'brent',      'chase',      'john',      'knox',      'sophia',      'emma',      'brooke',      'avery',      'caroline',      'margot',      'margaret',      'garrett',      'christina',      'emmy',      'greyson',      'claire',      'elizabeth',      'avalina',      'jackson',      'taylor',      'amara',      'juliana',      'ella',      'emma',      'katherine',      'anna',      'mary',      'eliana',      'nora',      'ansley',      'betsy',      'sophia',      'blair',      'grace',      'meriwether',      'paige',      'ria',      'andriana',      'amelia',      'hannah',      'teagan',      'beatrice',      'olivia',      'annabelle',      'madeline',      'collier',      'ella',      'havana',      'lillian',      'scarlett',      'mcvey',      'caroline',      'lilliana',      'layla',      'audrey',      'sienna',      'grace',      'charlie',      'leah',      'sasha',      'sophia',      'camilla',      'marley',      'eva',      'harley',      'makayla',      'grayson',      'claire',      'vanessa'  ],
    Ta = "present",
    Ia = "correct",
    Ca = "absent";
var Ma = {
...
var personName = Pa(new Date());
console.log(personName)




var amountofletters = personName.trim().length
const amountoflettersminus1 = amountofletters - 1
...
this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  const hello = amountofletters
  w.innerHTML = '\n  <style>\n    :host {\n      display: block;\n    }\n    :host([invalid]){\n      animation-name: Shake;\n      animation-duration: 600ms;\n    }\n    .row {\n      display: grid;\n      grid-template-columns: repeat(' + hello + ', 1fr);\n      grid-gap: 5px;\n    }\n    .win {\n      animation-name: Bounce;\n      animation-duration: 1000ms;\n    }\n\n    @keyframes Bounce {\n      0%, 20% {\n        transform: translateY(0);\n      }\n      40% {\n        transform: translateY(-30px);\n      }\n      50% {\n        transform: translateY(5px);\n      }\n      60% {\n        transform: translateY(-15px);\n      }\n      80% {\n        transform: translateY(2px);\n      }\n      100% {\n        transform: translateY(0);\n      }\n    }\n\n    @keyframes Shake {\n      10%,\n      90% {\n        transform: translateX(-1px);\n      }\n\n      20%,\n      80% {\n        transform: translateX(2px);\n      }\n\n      30%,\n      50%,\n      70% {\n        transform: translateX(-4px);\n      }\n\n      40%,\n      60% {\n        transform: translateX(4px);\n      }\n    }\n  </style>\n  <div class="row"></div>\n';
  ...
  Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">The going gets tough</div>\n          <div class="description">Each known letter must be used in subsequent attempts</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Black theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">High contrast colors</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback</div>\n        </div>\n        <div class="control">\n          <a href="https://docs.google.com/forms/d/e/1FAIpQLSdsUBTEaXMLi0RgAMvTcy3Z9ptHQotsggHMJ3qDH7LGY4a9Yw/viewform?usp=sf_link" target="blank" title="https://github.com/Igetsisss/Studentle">Github</a>\n          |\n                </div>\n      </div>\n    </section>\n  </div>\n  <div id="footnote">\n    <div id="puzzle-number"></div>\n    <div id="hash"></div>\n  <div>\n';
  var _a = function(e) {
      n(t, e);
      var a = h(t);
...
console.log(personName)
  ...
  var Qa = "IN_PROGRESS",
      Za = "WIN",
      es = "FAIL",
      as = ["Correct!!!", "Great Job!!!", "You Won!", "Amazing!", "Perfecto!", "Correct!"],
      ss = function(e) {
          n(t, e);
          var a = h(t);
          ...
          function t() {
              ...
              var o = za();
              return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || $a(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(7).fill(""), e.evaluations = new Array(7).fill(null), e.solution = Pa(e.today), e.dayOffset = Na(e.today), e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = !1, ja({
                  rowIndex: e.rowIndex,
          ...
          return o(t, [{
              key: "evaluateRow",
              value: function() {
                  if (amountofletters === this.tileIndex && !(this.rowIndex >= amountofletters)) {
                      var e, a = this.$board.querySelectorAll("game-row")[this.rowIndex],
                          s = this.boardState[this.rowIndex];
                      if (e = s, !La.includes(e) && !Aa.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Not a Student");
                      if (this.hardMode) {
                      ...
                      var i = this.rowIndex >= amountofletters,
              ...
              key: "addLetter",
              value: function(e) {
                  this.gameStatus === Qa && (this.canInput && (this.tileIndex >= amountofletters || (this.boardState[this.rowIndex] += e, this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("letters", this.boardState[this.rowIndex]), this.tileIndex += 1)))
              }
          }, {
              key: "removeLetter",
              value: function() {
              ...
              value: function() {
                  if (this.gameStatus === Qa && this.canInput) {
                      if (amountoflettersminus1 == this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Not enough letters");
                      this.evaluateRow()
                  }
              }
          }, {
              ...
              value: function() {
                  var e = this.shadowRoot.querySelector("#board-container"),
                      a = Math.min(Math.floor(e.clientHeight * (amountofletters / amountofletters)), 350),
                      s = amountofletters * Math.floor(a / amountofletters);
              ...
              value: function() {
                  ...
                  this.gameStatus === Za && this.rowIndex <= amountofletters && a.setAttribute("highlight-guess", this.rowIndex), a.gameApp = this, e.appendChild(a), e.setAttribute("open", "")
              }
          }, {
              key: "showHelpModal",
              value: function() {
              ...
              value: function() {
                  ...
                  for (var a = 0; a < amountofletters; a++) {
                      var s = document.createElement("game-row");
                      s.setAttribute("letters", this.boardState[a]), s.setAttribute("length", amountofletters), this.evaluations[a] && (s.evaluation = this.evaluations[a]), this.$board.appendChild(s)
                  }
                  this.$game.addEventListener("game-key-press", (function(a) {
                      ...
                      e.$keyboard.letterEvaluations = e.letterEvaluations, e.rowIndex < amountofletters && (e.canInput = !0);
              ...
              value: function() {
                  ...
                  for (var a = this.shadowRoot.getElementById("statistics"), s = this.shadowRoot.getElementById("guess-distribution"), t = Math.max.apply(Math, g(Object.values(this.stats.guesses))), o = 1; o < Object.keys(this.stats.guesses).length; o++) {
                      ...
                      us(function(e) {
                          ...
                          e.gameApp.addToast("Error coping results", 2e3, !0)
                      }))
                  }))
              }
          }]), t
  ...
  fs.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>How To Play <strong>STUDENTLE</strong> Students NAMES with the amount of Letters being the amount guesses</p>\n      <p>Studentle is forked from <a href="https://pietroppeter.github.io/wordle-it/">PAR🇮🇹LE</a> which is a pardoy of <a href="https://www.nytimes.com/games/wordle/index.html">WORDLE</a></p>\n      <p>After each attempt, the colors of the tiles will change to show you how close you came to guessing the word.</p>\n      <div class="examples">\n        <div class="example">\n          <div class="row">\n            <game-tile letter="j" evaluation="correct" reveal></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="k"></game-tile>\n                    </div>\n          <p>The letter <strong>J</strong> is in the word and is in the right place.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="g"></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="o" evaluation="present" reveal></game-tile>\n            <game-tile letter="r"></game-tile>\n            <game-tile letter="g"></game-tile>\n        <game-tile letter="e"></game-tile>\n   </div>\n          <p>The letter <strong>O</strong> is in the word but in the wrong place.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="o"></game-tile>\n            <game-tile letter="l"></game-tile>\n            <game-tile letter="t" evaluation="absent" reveal></game-tile>\n                      </div>\n          <p>The letter <strong>T</strong> is not in the word.</p>\n        </div>\n      </div>\n      <p><strong>A new game of STUDENTLE every day!<strong></p>\n    </div>\n  </section>\n';
  var ks = function(e) {
      n(t, e);
      var a = h(t);
