...
const numberofletters = rightGuessString.trim().length

console.log(numberofletters)



const NUMBER_OF_GUESSES = numberofletters;
...
function deleteLetter() {
  let row = document.getElementsByClassName("letter-row")[numberofletters - guessesRemaining];
...
// !
  if (guessString.length != numberofletters) {
