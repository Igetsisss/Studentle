...
'grayson',
'claire',
'vanessa'],     Ta = "present",     Ia = "correct",     Ca = "absent";
          ...
          return o(t, [{
                  ...
                  if (amountofletters === this.tileIndex && !(this.rowIndex >= amountofletters)) {
                      ...
                      if (this.hardMode) {
                          var t = function(e, a, s) {
                              ...
                              o = t.validGuess,
                              r = t.errorMessage;
                          if (!o) return a.setAttribute("invalid", ""), void this.addToast(r || "Not valid when the hard mode")
                      }
                      var n = function(e, a) {
              ...
              value: function() {
                  ...
                  this.$game.addEventListener("game-key-press", (function(a) {
                      ...
                      switch (t) {
                          case "hard-mode":
                              return void(r ? e.addToast("You can only activate 'Hard Mode' at the start of a game", 1500, !0) : (e.hardMode = o, ja({
                                  hardMode: o
                              })))
                      }
